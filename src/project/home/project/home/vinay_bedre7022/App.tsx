...
const questions = [
  {
    id: 1,
    question:
      "How likely are you to doze off or fall asleep while sitting and reading, such as reading a book?",
  },
  {
    id: 2,
    question:
  ...
  },
  {
    id: 3,
    question:
      "How likely are you to doze off or fall asleep while sitting in a public place, such as a bus or train?",
  },
  {
    id: 4,
    question:
      "How likely are you to doze off or fall asleep while driving or riding in a car?",
  },
  {
    id: 5,
    question:
      "How likely are you to doze off or fall asleep while talking to someone?",
  },
  {
    id: 6,
    question:
      "How likely are you to doze off or fall asleep while relaxing or taking a break?",
  },
  {
    id: 7,
    question:
  ...
  },
  {
    id: 8,
    question:
      "How likely are you to doze off or fall asleep in a car while stopped for a few minutes in traffic?",
  },
];
...
const EpworthSleepinessScale = () => {
  ...
  const handleAnswerChange = (questionId, answerId) => {
    ...
    const newScore = Object.values({
      ...selectedAnswers,
      [questionId]: answerId,
    }).reduce((acc, answerId) => acc + answerId, 0);
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Please answer the following questions to assess your daytime
          sleepiness.
        </CardDescription>
      </CardHeader>
      <CardContent>
